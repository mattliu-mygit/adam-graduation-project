const messages = [
  ...
  },
  {
    name: "𝓒𝓪𝓻𝓸𝓵 𝓛𝓾",
    message: [
      "Hi Anna!! Can’t believe we joined lion dance together back in freshman year and now we’re graduating. -Carol",
    ],
    images: [],
  },
  {
  ...
  },
  {
    name: "𝓒𝓪𝓻𝓸𝓵 𝓛𝓾",
    message: [
      "Jack!! I miss you my dude! I know you’ve been hella busy BMEing and DJing which is all really awesome. Hope to see you around even after graduation. -Carol",
    ],
    images: [],
  },
  {
  ...
  },
  {
    name: "𝓒𝓪𝓻𝓸𝓵 𝓛𝓾",
    message: [
      "Kevin!! You’re my side bitch but I love you so much. You encourage me to be the absolute worst version of myself. PS you’re a slut. -Carol",
    ],
    images: [],
  },
  {
